            ...
            <div class="card border-danger">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?= base_url();?>kunjungan/insert_rm">
                                ...
                                <textarea name="keluhan" class="form_control"required><?= $d['keluhan_pasien'];?></textarea>
                                </div>
                                <div class="form-group">
                                <label for="">Diagnosa</label>
                                <textarea name="diagnosa" class="form_control"required><?= $d['hasil_diagnosa'];?></textarea>
                                </div>
                                <div class="form-group">
