        ...
        <div class="card border-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                        ...
                        <input type="date" name="tgl_berobat" value="<?= $edit['tgl_berobat']; ?>" class="form_control" required>
                    </div>
                    <div class="form-group">
                        <label for="">Pasien</label>
                        <select name="pasien" id="" class="from_control" required>
                          <?php 
                          foreach($pasien as $r){
                    ...
                    <div class="form-group">
                        ...
                        <select name="dokter" id="" class="from_control" required>
